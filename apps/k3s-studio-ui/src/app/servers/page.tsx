  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/servers/new"
          className="inline-flex items-center gap-2 rounded-pill active:scale-95 bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-all"
        >
